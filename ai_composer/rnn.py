...
def train_model(pickle_file=None):
    np.random.seed()      
    ...
    parser.add_argument('--pickle_file', type=str, default=nottingham_util.PICKLE_LOC)

    args = parser.parse_args()

    if args.pickle_file is None and pickle_file is not None:
